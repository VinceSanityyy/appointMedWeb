  ...
  <div>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body table-responsive">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr v-for="(sec,key) in secretaries" :key="key">
                                    <td>
                                        <img :src=sec.imageUrl height="42" width="42" class="img-rounded">
                                    </td>
                                    <td>{{sec.name}}</td>
                                    <td>{{sec.doctor}}</td>
                                    <td>
                                        &emsp;
                                        <a href="#" >
                                        <i class="fa fa-edit" @click="editModal(sec,key)"></i>
                                        </a>
                                        &emsp;
                                         <a href="#">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form @submit.prevent = "editmode? updateSecretary() : addSecretary()">
            <div class="modal-body">
                 <div class="form-group">
                        <label for="exampleInputEmail1">Secretary Name</label>
...
export default {
    ...
    methods:{
        ...
        onFileSelected(event){ 
            ...
            this.image = firebase.storage().ref('secretaryImages/' + this.imageFile.name)
        ...
        getDoctors(){
            firebase.database().ref('users/doctors').on('value',(snapshot)=>{
                ...
                snapshot.forEach(ss => {
                    this.arr.push(ss.child('name').val());
                });
